...
public class MainController implements Initializable {
	...
	private void handleButtonAction(ActionEvent event)
	{
		...
		FileChooser.ExtensionFilter filter=new FileChooser.ExtensionFilter("Select a file", "*.mp3","*.m4a","*.wav");
		    ...
		    public void handle(MouseEvent click) {
		        if (click.getClickCount() == 2) {
		            ...
		            String currentItemSelected = list.getSelectionModel().getSelectedItem();
		               ...
		               mp.stop();
		               currentItemSelected=file.toURI().toString();
		               
		       			me=new Media(currentItemSelected);
		       			mp=new MediaPlayer(me);
		       			mv.setMediaPlayer(mp);
